...
typedef struct{
	...
	DIO_OUTPUTLEVEL latchActiveType;
...
void SHIFT_REGISTER_voidInitSIPO(
	...
	CLK_TRIG_EDGE_t _clkTrigEdge, DIO_OUTPUTLEVEL _latchActiveType,
...
void SHIFT_REGISTER_voidCopy(SIPO_SHIFT_REGISTER_t* regPtr1, SIPO_SHIFT_REGISTER_t* regPtr2);
